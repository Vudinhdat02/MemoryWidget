...
APK nằm ở `app/build/outputs/apk/release/app-release.apk`. Các bước chi tiết (kèm cách kiểm tra chữ ký và lỗi thường gặp) xem [HUONG_DAN_XUAT_APK.md](HUONG_DAN_XUAT_APK.md). Cần khai báo đường dẫn SDK qua biến môi trường `ANDROID_HOME`
